...
LANG_TEMPLATES = {
    ...
    "de": {
        "general": (PROMPT_DIR / "fiche_generale_de.txt").read_text(encoding="utf-8"),
        "context": (PROMPT_DIR / "fiche_contexte_de.txt").read_text(encoding="utf-8"),
    },
    "it": {
        "general": (PROMPT_DIR / "fiche_generale_it.txt").read_text(encoding="utf-8"),
        "context": (PROMPT_DIR / "fiche_contexte_it.txt").read_text(encoding="utf-8"),
    },
}
